## Fox Restart [Firefox Addon]

This addon adds a toolbar button, a menu item and a shortcut that allow restart the browser.

The menu item is in the File menu.
The default shortcut is Alt+R.

---

To **install** the addon go to [releases](https://github.com/mortalis13/Fox-Restart/releases) and click on the **.xpi** file or download and drag it to the browser window.
